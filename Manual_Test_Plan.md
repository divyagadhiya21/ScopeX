...
| LOG-008 | Verify user sessions are active in 2 different systems simultaneously | Enter a valid email and password in 2 different systems simultaneously, and click "Log in." | Do not allow login with the second session if the first is still active. |
